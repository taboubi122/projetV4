...
export class HotelsService {
   ...
   private HotelsTunis:Sejour[]=[
    ...
    new Sejour('DEHS21','','dar el jeld hôtel & spa','tunis','hotel','',80,100,false,new Date(22,11,2021),new Date(22,11,2021),5,
...
HotelsHammamet:Sejour[]=[
  ...
  ['x','y']),
  new Sejour('EYRMS21','','eden yasmine resort meeting & spa','hammamet','hotel','',90,100,false,new Date(22,11,2021),new Date(22,11,2021),4,
